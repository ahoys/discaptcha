...
module.exports = (Client, Message) => {
  try {
    ...
    const keys = isBotOwner
      ...
      : Object.keys(commands).filter(key => commands[key].permissions.owner || commands[key].permissions.moderator);
    keys
      .forEach((key, i) => {
        ...
        const ownerPermission = !permissions.owner
          ...
          : '';
        const modPermission = !permissions.moderator && permissions.owner
